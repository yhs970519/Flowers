...
window.addEventListener('DOMContentLoaded', function(){
    ...
    let red1 = Math.floor(Math.random() * 56) + 200;
    let green1 = Math.floor(Math.random() * 31);
    let blue1 = Math.floor(Math.random() * 71);

    let red2 = Math.floor(Math.random() * 56) + 200;
    let green2 = Math.floor(Math.random() * 31);
    let blue2 = Math.floor(Math.random() * 71);

    let red3 = Math.floor(Math.random() * 56) + 200;
    let green3 = Math.floor(Math.random() * 31);
    let blue3 = Math.floor(Math.random() * 71);
