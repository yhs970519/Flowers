...
window.addEventListener('DOMContentLoaded', function(){
    ...
    function flower() {
        ...
        // $(canvasGroup1).hover(function() {
        //     $(this).css("transform", "rotateZ(" + 20 + "deg)");
        // }, function() {
        //     $(this).css("transform", "rotate(" + random1 + "deg)");
        // });
        ...
        function leafMotion() {
            ...
            // $(hanamove)
            // .animate2({ transform: 'rotate(' + random3_1 + 'deg)' }, 130)
            // .animate2({ transform: 'rotate(' + random3_2 + 'deg)' }, 100)
            // .animate2({ transform: 'rotate(0deg)' }, 135);
        }
