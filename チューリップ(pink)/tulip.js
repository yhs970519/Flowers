...
window.addEventListener('DOMContentLoaded', function(){
    ...
    let red1 = Math.floor(Math.random() * 31) + 225;
    let green1 = Math.floor(Math.random() * 31) + 160;
    let blue1 = Math.floor(Math.random() * 31) + 170;

    let red2 = Math.floor(Math.random() * 31) + 225;
    let green2 = Math.floor(Math.random() * 31) + 160;
    let blue2 = Math.floor(Math.random() * 31) + 170;

    let red3 = Math.floor(Math.random() * 31) + 225;
    let green3 = Math.floor(Math.random() * 31) + 160;
    let blue3 = Math.floor(Math.random() * 31) + 170;
