...
window.addEventListener('DOMContentLoaded', function(){
    ...
    let red1 = Math.floor(Math.random() * 56) + 120;
    let green1 = Math.floor(Math.random() * 71);
    let blue1 = Math.floor(Math.random() * 56) + 200;

    let red2 = Math.floor(Math.random() * 56) + 120;
    let green2 = Math.floor(Math.random() * 71);
    let blue2 = Math.floor(Math.random() * 56) + 200;

    let red3 = Math.floor(Math.random() * 56) + 120;
    let green3 = Math.floor(Math.random() * 71);
    let blue3 = Math.floor(Math.random() * 56) + 200;
